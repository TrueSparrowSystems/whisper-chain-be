...
class CronBase {
  ...
  attachHandlers() {
    ...
    const handle = async function() {
      ...
      // Sleep to give some breathing space to cancel consume. So by chance if during cancellation new message arrives, it get considered
      ...
      if (oThis._pendingTasksDone()) {
        ...
        // Consider breaking this function into 2 parts:
