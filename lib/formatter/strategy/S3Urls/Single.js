...
/**
 * Class for s3 urls formatter.
 *
 * @class S3UrlsFormatter
 */
class S3UrlsFormatter extends BaseFormatter {
  /**
   * Constructor for s3 urls formatter.
   *
   * @param {object} params
...
module.exports = S3UrlsFormatter;
