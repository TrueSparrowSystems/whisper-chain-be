      ...
      oThis.bot.on('message', async function(msg) {
        ...
        try {
          ...
          try {
            ...
            console.log(`Request from unauthorised user ${error}`);
            oThis.bot.sendMessage(messageContext.message.chat.id, 'You are not an Admin.');
          }
        ...
        oThis.bot.sendMessage(chatId, 'Received image. Seeding process is completed!');
        oThis.processMessageCount--;
