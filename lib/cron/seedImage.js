...
class SeedImage extends CronBase {
  ...
  async _seedImageFromTelegram() {
    ...
    await bot.on('message', async function(msg) {
      ...
      // TODO - setting oThis.maxPhoto is dangerous. We should create a message context and pass it around to all the following methods.
      ...
      try {
        ...
        // TODO - SIGINT handling needs change.
      } catch (error) {
        console.error(`Error while seeding image: ${error}`);
      }
      // Send a message to the chat acknowledging receipt of their message
      bot.sendMessage(chatId, 'Received image. Seeding process is completed!');
    });
  }
   ...
   * @private
   */
  // TODO - throw if not admin. Catch it in caller to return from flow.
  ...
  async _getImageFromMessage() {
    ...
    // TODO - setting oThis.message is dangerous. We should set it in message context.
  ...
  async _getImageFileForDownload() {
    ...
    // TODO - setting oThis.filePath is dangerous. We should set it in message context.
  ...
  async _downloadImage() {
    ...
    // TODO - setting oThis.localFilePath is dangerous. We should set it in message context.
    ...
    return new Promise(function(onResolve) {
      ...
      AWSS3.upload(params)
        ...
        .then(function(resp) {
          ...
          // TODO - setting oThis.s3Url is dangerous. Let's use message context for it.
  ...
  async _createEntryInImage() {
    ...
    // TODO - setting oThis.imageId is dangerous. Let's use message context for it.
  }
